...
typedef struct judgetime judgetime, *Pjudgetime;

struct judgetime {
	int poor;
	int bad;
	int good;
	int great; /* Created by retype action */
	int pgreat;
};

typedef struct KeyboardInput KeyboardInput, *PKeyboardInput;
